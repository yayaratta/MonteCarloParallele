...
int main (int argc, char** argv) {
    ...
    monteCarlo->price(past,t,prix,ic);

    cout << "Price sur option CALL à t : \n";
    cout << "\n---> Prix : " << prix;

    double prixFF;
    prixFF = pnl_bs_call(pastArray[NB_TIMEVALUE_KNOWN-1][0],K,maturity-t,r,0,sigmaV);
